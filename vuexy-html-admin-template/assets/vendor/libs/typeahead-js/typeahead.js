                        ...
                        return (
                          ...
                          n.each(r, function (n) {
                            ...
                            (o = u._injectQuery(i, n)),
                              (r = e(u.templates.suggestion(o))
                                .data(t.obj, n)
                                .data(t.val, u.displayFn(n))
                                .addClass(
                                  u.classes.suggestion +
                                    " " +
                                    u.classes.selectable
                                )),
                              s.appendChild(r[0]);
                          }),
                          this.highlight &&
                        ...
                        return (
                          ...
                          this.each(function () {
                            ...
                            n.each(o, function (e) {
                                ...
                                (p = (function (t, e) {
                                  return t
                                    ...
                                    .css(
                                      ((n = t),
                                      {
                                        backgroundAttachment: n.css(
                                          "background-attachment"
                                        ),
                                        backgroundClip:
                                          n.css("background-clip"),
                                        backgroundColor:
                                          n.css("background-color"),
                                        backgroundImage:
                                          n.css("background-image"),
                                        backgroundOrigin:
                                          n.css("background-origin"),
                                        backgroundPosition: n.css(
                                          "background-position"
                                        ),
                                        backgroundRepeat:
                                          n.css("background-repeat"),
                                        backgroundSize:
                                          n.css("background-size"),
                                      })
                                    )
                                    .prop("readonly", !0)
                              ...
                              (S = y ? h : c),
                              (v = new r({ el: i })),
                              (_ = new u({ hint: p, input: i }, a)),
                              (b = new S({ node: g, datasets: o }, a)),
                              (w = new l(
                                {
                                  input: _,
                                  menu: b,
                          ...
                          a(this, function (t, e) {
                            (function (t) {
                              ...
                              (e = t.data(s.www)),
                                ...
                                t
                                  .removeData(s.typeahead)
                                  .removeData(s.www)
                                  .removeData(s.attr)
                                  .removeClass(e.classes.input),
                                i.length &&
                                  (t.detach().insertAfter(i), i.remove());
                            })(e),
                              t.destroy();
                          }),
                          this
